-- DATABASE SCHEMA SCRIPT for Gear Grab Digital
...
CREATE TABLE Equipment_Models (
    ...
    CategoryID INTEGER,
    Name VARCHAR(255) NOT NULL,
    ReplacementCost DECIMAL(10, 2), -- Updated for financial precision
...
-- ==========================================
-- 3. DATA INSERTION (Based on "Gear Grab" Service)
-- ==========================================

-- --- A. CATEGORIES ---
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Camera Body', 3);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Camera Lens', 3);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Lighting', 1);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Tripods & Support', 3);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Audio & Microphones', 3);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Drones', 1);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Stabilizers & Gimbals', 2);
INSERT INTO Categories (Name, MaxLoanDays) VALUES ('Studio Accessories', 3);
...
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (1, 'Canon EOS M50 Mark II', 30000.00);

-- 2. Camera Lenses
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (2, 'Sony E PZ 16-50mm Kit Lens', 8000.00);
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (2, 'Sigma 16mm f/1.4 DC DN', 19000.00);
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (2, 'Sony E 50mm f/1.8 OSS', 12000.00);
...
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (3, 'Continuous Light 105W', 1200.00);

-- 4. Tripods
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (4, 'Yunteng Video Tripod', 1500.00);
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (4, 'Manfrotto Compact Action', 4000.00);

-- 5. Audio
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (5, 'DJI Mic Mini Wireless', 15000.00);
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (5, 'Rode VideoMicro', 3000.00);

-- 6. Drones
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (6, 'DJI Mini 2', 25000.00);
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (6, 'DJI Mini 3 Pro', 40000.00);

-- 7. Stabilizers
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (7, 'DJI Ronin SC', 18000.00);
INSERT INTO Equipment_Models (CategoryID, Name, ReplacementCost) VALUES (7, 'Zhiyun Crane M2', 12000.00);
...
-- --- D. MEMBERS ---
INSERT INTO Members (Name, Email, PhoneNumber, IsOfficer) VALUES ('Juan DelaCruz', 'juan.delacruz@school.edu', '0912-345-6789', 0);
INSERT INTO Members (Name, Email, PhoneNumber, IsOfficer) VALUES ('Mhalik Perez', 'mhalik.perez@school.edu', '0998-765-4321', 1);